...
COLOR_THEMES = {
    ...
    "ブラック × ゴールド（※画像が暗くなるため非推奨）": "背景: ブラック(#0a0a0a, #1a1a1a), アクセント: ゴールド(#d4a017, #f4c430), テキスト: 白/ゴールド, CTA: ゴールドグラデーション",
    "ホワイト × グリーン": "背景: 白(#ffffff), サブ背景: ミントグリーン(#f0fdf4), アクセント: グリーン(#16a34a), テキスト: ダークグレー(#1e293b), CTA: グリーングラデーション",
    "ダークパープル × ピンク（※画像がやや暗め）": "背景: ダークパープル(#1a0533, #2d1b69), アクセント: ピンク(#ec4899, #f472b6), テキスト: 白/ラベンダー, CTA: ピンクグラデーション",

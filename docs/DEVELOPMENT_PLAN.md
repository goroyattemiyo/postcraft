...
| ID | タスク | 状態 |
|----|--------|------|
| 4-1 | brain_draft.md 生成ロジック | 完了 |
| 4-2 | note_draft.md 生成ロジック | 完了 |
| 4-3 | posting_guide.md 生成 | 完了 |
...
|----|--------|------|
| 5-1 | モード切替UI追加 | 完了 |
| 5-2 | 成果物プレビュー・ZIPダウンロード | 完了 |
| 5-3 | HTMLプレビュー（iframe） | 完了 |
